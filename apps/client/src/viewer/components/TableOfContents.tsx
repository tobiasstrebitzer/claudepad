  ...
  return (
    <nav aria-label="Table of contents" className="flex h-full flex-col">
      <div className="mb-2 flex items-center justify-between px-1">
        <span className="text-label uppercase tracking-[0.02em] text-muted-foreground">Turns</span>
        {onCollapse && (
          <button
            type="button"
            onClick={onCollapse}
            aria-label="Hide table of contents"
            className="rounded-sm p-0.5 text-muted-foreground hover:text-accent"
          >
              ...
              <button
                ...
                className={cn(
                  ...
                  active
                    ...
                    : 'text-muted-foreground hover:bg-sidebar hover:text-text'
                )}
              >

...
- [`prd-13-usage-insights.md`](./prd-13-usage-insights.md) - **active / next:** the Usage Insights ("Usage Stats") analytics surface (token/cost/time reporting over the connected vault, client-side).

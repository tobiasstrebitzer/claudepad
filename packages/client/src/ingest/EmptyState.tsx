            ...
            {guides.map((g, i) => (
              <div key={g.os} className={cn(i > 0 && 'border-t border-border pt-3')}>
                ...
                <div className="mt-2 flex items-center gap-2">
                  <code className="min-w-0 flex-1 truncate rounded-sm bg-sidebar px-2 py-1 font-mono text-code text-muted-foreground">
                    {g.listOneLiner}
                  </code>
                  <button
                    type="button"
                    ...
                    className="inline-flex items-center gap-1 rounded-sm px-2 py-1 text-label text-muted-foreground hover:bg-accent-tint hover:text-accent"
                  >
                    {copied ? (
